...
void A_transpose_dot_B(const float *A, const float *B, float *C, size_t n, size_t m, size_t k);

void A_dot_B_transpose(const float *A, const float *B, float *C, size_t m, size_t n, size_t k);
