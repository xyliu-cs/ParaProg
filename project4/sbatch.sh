...
# Softmax Profile
# srun -n 1 --gpus 1 nsys profile -t cuda,nvtx,osrt,openacc -o ./profiling/softmax_openacc.qdrep ${CURRENT_DIR}/build/softmax_openacc $TRAIN_X $TRAIN_Y $TEST_X $TEST_Y
...
# NN Profile
# srun -n 1 --gpus 1 nsys profile -t cuda,nvtx,osrt,openacc -o ./profiling/nn_openacc.qdrep ${CURRENT_DIR}/build/nn_openacc $TRAIN_X $TRAIN_Y $TEST_X $TEST_Y